...
function DisplayLoginPage(req, res, next) {
    if (!req.user) {
        return res.render('login', { title: 'Login', page: 'login', messages: req.flash('loginMessage'), displayName: Util_1.UserDisplayName(req) });
    }
...
function DisplayRegisterPage(req, res, next) {
    if (!req.user) {
        return res.render('register', { title: 'Register', page: 'register', messages: req.flash('registerMessage'), displayName: Util_1.UserDisplayName(req) });
    }
    return res.redirect('/contacts_list');
}
