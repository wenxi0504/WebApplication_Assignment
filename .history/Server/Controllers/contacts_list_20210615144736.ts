...
export function DisplayClothingListPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    contact.find((err, contactCollection) =>
    {
        ...
        res.render('index', { title: 'contacts_list', page: 'contacts_list', contacts_list: contactCollection  });
    });
}
...
export function DisplayEditPage(req: Request, res: Response, next: NextFunction): void
{
    ...
    contact.findById(id, {}, {}, (err, contactItemToEdit) => 
    {
        ...
        // show the edit view
        res.render('index', { title: 'Edit', page: 'update', contacts_list: contactItemToEdit  });
    });
}
...
{
    // show the edit view
    res.render('index', { title: 'Add', page: 'update', contacts_list: '' });
}
